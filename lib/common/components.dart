...
keyboardType: isNumber ? TextInputType.number : TextInputType.text,
            ...
            decoration: InputDecoration(
              ...
              fillColor: fillColor ?? whiteFF_26,
              filled: true,
...
Widget horizontalChapterItem(Color color,String icon, String title,String subTitle,Function onTap,{double width=24,double height=24,bool isFixWidth=false,bool transparentColor=false, Color? iconColor}){
  ...
  return GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        color: transparentColor ? Colors.transparent : whiteFF_26,
        borderRadius: borderRadius(radius: 15),
      ),
      ...
      children: [
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            color: state ? green77() : greyE7,
            boxShadow: [
              // boxShadow(greyD0.withOpacity(.2),blur: 10,y: 3)
            ]
          ),
        ),
      ...
      children: [
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            color: state ? green77() : whiteFF_26,
          ),
...
Widget phoneInputWithCountry({
  required CountryCode countryCode,
  required Function() onPickCountry,
  required TextEditingController controller,
  required FocusNode node,
  required String hint,
  double flagBoxSize = 52,
  double gap = 15,
}) {
  return Row(
    children: [
...
Widget tabBar(Function(int) onChangeTab, TabController tabController,List<Widget> tab,{double horizontalPadding = 14}){
  return Align(
    ...
    child: TabBar(
      ...
      indicator: RoundedTabIndicator(color: green77()),
