...
import 'package:webinar/app/pages/main_page/home_page/single_course_page/course_code_page.dart';
...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  // لو حابب تظهر اشعار في الخلفية فعّل السطر ده
  // showFlutterNotification(message);
}

/// ✅ دالة مضمونة لطباعة التوكن (مع Permission + Retry)
Future<void> _ensureFcmTokenPrinted() async {
  try {
...
Future<void> main() async {
  ...
  // ✅ لا نستخدم flutter_windowmanager هنا نهائيًا
  // لأنك عامل FLAG_SECURE بالفعل في MainActivity.kt على Android
        ...
        builder: (context, provider, _) {
          return MaterialApp(
            ...
            routes: {
              ...
              CourseCodePage.pageName: (context) => const CourseCodePage(),
